...
export default async function RegisterPage({
  ...
  return (
    <div className="mt-4 flex min-h-[calc(100vh-4rem)] md:mt-6">
      ...
      <div className="flex w-full lg:w-1/2 items-center justify-center px-4 py-12">
        <div className="w-full max-w-md space-y-6">
          <div className="space-y-2 text-center">
            <p className="text-sm font-medium text-primary tracking-wider uppercase lg:hidden">
              {SITE_NAME}
            </p>
            <h1 className="text-3xl font-bold">{t("createAccount")}</h1>
            <p className="text-muted-foreground">{t("signUpMessage")}</p>
          </div>
