    ...
    alternates: {
      ...
      languages: Object.fromEntries(
        routing.locales.map((l) => [
          l,
          buildCanonicalUrl(`/${l}/tin-tuc/${slug}`),
        ]),
      ),
    },
    openGraph: {
      ...
      images: getArticleImageUrl(item)
        ? [{ url: getArticleImageUrl(item)! }]
        : undefined,
    },
  };
}

async function NewsDetailInner({
  locale,
  slug,
}: {
  locale: string;
        ...
        <section className="relative w-full h-[55vh] min-h-[420px] max-h-[620px] overflow-hidden bg-muted">
          ...
          <div className="absolute bottom-0 left-0 right-0 p-6 md:p-12 lg:p-16">
            <div className="max-w-[720px] mx-auto w-full">
              ...
              <h1 className="font-category-title text-3xl sm:text-4xl md:text-5xl text-white tracking-tight leading-[1.1]">
                {item.title}
              </h1>
