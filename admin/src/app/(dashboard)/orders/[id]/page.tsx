    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-2">
          <Badge
            variant={
              statusColors[(order as OrderDetail)?.status || ""] || "secondary"
            }
        ...
        <CardContent>
          ...
          <div className="mt-4 space-y-1 text-sm border-t pt-4">
            ...
            <div className="flex justify-between">
              ...
              <span>{fmt(order?.shippingTotal || 0)}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-muted-foreground">Giảm giá</span>
              <span>-{fmt(order?.discountTotal || 0)}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-muted-foreground">Thuế</span>
              <span>{fmt(order?.taxTotal || 0)}</span>
            </div>
            <div className="flex justify-between font-semibold text-base border-t pt-2">
              <span>Tổng cộng</span>
              <span>{fmt(order?.grandTotal || 0)}</span>
            </div>
          </div>
        </CardContent>
      </Card>
