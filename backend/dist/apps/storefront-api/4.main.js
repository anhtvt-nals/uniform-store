...
/* harmony import */ var _resolveProfileData__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(2599);
...
const fromIni = (init = {}) => async ({ callerClientConfig } = {}) => {
    ...
    return (0,_resolveProfileData__WEBPACK_IMPORTED_MODULE_2__.resolveProfileData)((0,_smithy_core_config__WEBPACK_IMPORTED_MODULE_0__.getProfileName)({
...
/* harmony export */ });
/* harmony import */ var _fromIni__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2598);
...
/* harmony import */ var _smithy_core_config__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1914);
/* harmony import */ var _smithy_core_config__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(1917);
/* harmony import */ var _resolveCredentialSource__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(2601);
...
const resolveAssumeRoleCredentials = async (profileName, profiles, options, callerClientConfig, visitedProfiles = {}, resolveProfileData) => {
    ...
    if (!options.roleAssumer) {
        const { getDefaultRoleAssumer } = await __webpack_require__.e(/* import() */ 12).then(__webpack_require__.bind(__webpack_require__, 2681));
    ...
    if (source_profile && source_profile in visitedProfiles) {
        throw new _smithy_core_config__WEBPACK_IMPORTED_MODULE_1__.CredentialsProviderError(`Detected a cycle attempting to resolve credentials for profile` +
            ` ${(0,_smithy_core_config__WEBPACK_IMPORTED_MODULE_2__.getProfileName)(options)}. Profiles visited: ` +
    ...
    if (isCredentialSourceWithoutRoleArn(profileData)) {
        ...
        if (mfa_serial) {
            if (!options.mfaCodeProvider) {
                throw new _smithy_core_config__WEBPACK_IMPORTED_MODULE_1__.CredentialsProviderError(`Profile ${profileName} requires multi-factor authentication, but no MFA code callback was provided.`, { logger: options.logger, tryNextLink: false });
            }
...
/* harmony import */ var _aws_sdk_core_client__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2057);
/* harmony import */ var _smithy_core_config__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1914);
/* harmony import */ var _smithy_core_config__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(1910);


const resolveCredentialSource = (credentialSource, profileName, logger) => {
    const sourceProvidersMap = {
        EcsContainer: async (options) => {
            const { fromHttp } = await __webpack_require__.e(/* import() */ 8).then(__webpack_require__.bind(__webpack_require__, 2631));
            const { fromContainerMetadata } = await __webpack_require__.e(/* import() */ 7).then(__webpack_require__.bind(__webpack_require__, 2616));
            logger?.debug("@aws-sdk/credential-provider-ini - credential_source is EcsContainer");
            return async () => (0,_smithy_core_config__WEBPACK_IMPORTED_MODULE_2__.chain)(fromHttp(options ?? {}), fromContainerMetadata(options))().then(setNamedProvider);
        },
        Ec2InstanceMetadata: async (options) => {
            logger?.debug("@aws-sdk/credential-provider-ini - credential_source is Ec2InstanceMetadata");
            const { fromInstanceMetadata } = await __webpack_require__.e(/* import() */ 7).then(__webpack_require__.bind(__webpack_require__, 2616));
            return async () => fromInstanceMetadata(options)().then(setNamedProvider);
        },
        Environment: async (options) => {
            logger?.debug("@aws-sdk/credential-provider-ini - credential_source is Environment");
            const { fromEnv } = await __webpack_require__.e(/* import() */ 14).then(__webpack_require__.bind(__webpack_require__, 2705));
    ...
    if (credentialSource in sourceProvidersMap) {
        ...
        throw new _smithy_core_config__WEBPACK_IMPORTED_MODULE_1__.CredentialsProviderError(`Unsupported credential source in profile ${profileName}. Got ${credentialSource}, ` +
...
const resolveLoginCredentials = async (profileName, options, callerClientConfig) => {
    const { fromLoginCredentials } = await __webpack_require__.e(/* import() */ 15).then(__webpack_require__.bind(__webpack_require__, 2706));
...
const resolveProcessCredentials = async (options, profile) => {
    const { fromProcess } = await __webpack_require__.e(/* import() */ 5).then(__webpack_require__.bind(__webpack_require__, 2607));
    const credentials = await fromProcess({
        ...options,
        profile,
    })();
    return (0,_aws_sdk_core_client__WEBPACK_IMPORTED_MODULE_0__.setCredentialFeature)(credentials, "CREDENTIALS_PROFILE_PROCESS", "v");
};
...
/* harmony import */ var _resolveAssumeRoleCredentials__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2600);
/* harmony import */ var _resolveLoginCredentials__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(2602);
/* harmony import */ var _resolveProcessCredentials__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(2603);
/* harmony import */ var _resolveSsoCredentials__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(2604);
/* harmony import */ var _resolveStaticCredentials__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(2605);
/* harmony import */ var _resolveWebIdentityCredentials__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(2606);
...
const resolveProfileData = async (profileName, profiles, options, callerClientConfig, visitedProfiles = {}, isAssumeRoleRecursiveCall = false) => {
    ...
    throw new _smithy_core_config__WEBPACK_IMPORTED_MODULE_0__.CredentialsProviderError(`Could not resolve credentials using profile: [${profileName}] in configuration/credentials file(s).`, { logger: options.logger });
};
...
const resolveSsoCredentials = async (profile, profileData, options = {}, callerClientConfig) => {
    const { fromSSO } = await __webpack_require__.e(/* import() */ 2).then(__webpack_require__.bind(__webpack_require__, 2578));
    return fromSSO({
        profile,
...
const resolveWebIdentityCredentials = async (profile, options, callerClientConfig) => {
    const { fromTokenFile } = await __webpack_require__.e(/* import() */ 6).then(__webpack_require__.bind(__webpack_require__, 2613));
    ...
    return (0,_aws_sdk_core_client__WEBPACK_IMPORTED_MODULE_0__.setCredentialFeature)(credentials, "CREDENTIALS_PROFILE_STS_WEB_ID_TOKEN", "q");
};
