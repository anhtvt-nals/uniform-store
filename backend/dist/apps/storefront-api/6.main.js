...
/* harmony import */ var _smithy_core_config__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(2610);
/* harmony import */ var node_fs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(983);
...
/* harmony import */ var _fromWebToken__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(2615);
...
const fromTokenFile = (init = {}) => async (awsIdentityProperties) => {
    ...
    if (!webIdentityTokenFile || !roleArn) {
        throw new _smithy_core_config__WEBPACK_IMPORTED_MODULE_1__.CredentialsProviderError("Web identity configuration not specified", {
            logger: init.logger,
        });
    }
    const credentials = await (0,_fromWebToken__WEBPACK_IMPORTED_MODULE_4__.fromWebToken)({
        ...init,
        webIdentityToken: _smithy_core_config__WEBPACK_IMPORTED_MODULE_2__.externalDataInterceptor?.getTokenRecord?.()[webIdentityTokenFile] ??
...
const fromWebToken = (init) => async (awsIdentityProperties) => {
    ...
    if (!roleAssumerWithWebIdentity) {
        const { getDefaultRoleAssumerWithWebIdentity } = await __webpack_require__.e(/* import() */ 12).then(__webpack_require__.bind(__webpack_require__, 2681));
...
/* harmony export */ });
/* harmony import */ var _fromTokenFile__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2614);
/* harmony import */ var _fromWebToken__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2615);
