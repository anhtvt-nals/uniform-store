...
/* harmony import */ var _smithy_core_config__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1927);
/* harmony import */ var _smithy_core_protocols__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(1859);
/* harmony import */ var node_crypto__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(1247);
...
/* harmony import */ var node_fs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(983);
...
/* harmony import */ var node_os__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(1924);
...
/* harmony import */ var node_path__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(982);
...
class LoginCredentialsFetcher {
    ...
    async loadCredentials() {
        ...
        if (!token) {
            throw new _smithy_core_config__WEBPACK_IMPORTED_MODULE_0__.CredentialsProviderError(`Failed to load a token for session ${this.loginSession}, please re-authenticate using aws login`, { tryNextLink: false, logger: this.logger });
        }
    ...
    async refresh(token) {
        const { SigninClient, CreateOAuth2TokenCommand } = await Promise.all(/* import() */[__webpack_require__.e(11), __webpack_require__.e(16)]).then(__webpack_require__.bind(__webpack_require__, 2709));
        ...
        try {
            ...
            if (!accessKeyId || !secretAccessKey || !sessionToken || !refreshToken) {
                throw new _smithy_core_config__WEBPACK_IMPORTED_MODULE_0__.CredentialsProviderError("Token refresh response missing required fields", {
                    logger: this.logger,
                    tryNextLink: false,
                });
            }
            ...
            if (error.name === "AccessDeniedException") {
                ...
                throw new _smithy_core_config__WEBPACK_IMPORTED_MODULE_0__.CredentialsProviderError(message, { logger: this.logger, tryNextLink: false });
            }
            throw new _smithy_core_config__WEBPACK_IMPORTED_MODULE_0__.CredentialsProviderError(`Failed to refresh token: ${String(error)}. Please re-authenticate using aws login`, { logger: this.logger });
        }
    }
    async loadToken() {
        ...
        try {
            let tokenData;
            try {
                tokenData = await (0,_smithy_core_config__WEBPACK_IMPORTED_MODULE_1__.readFile)(tokenFilePath, { ignoreCache: this.init?.ignoreCache });
            }
            catch {
            ...
            if (missingFields.length > 0) {
                throw new _smithy_core_config__WEBPACK_IMPORTED_MODULE_0__.CredentialsProviderError(`Token validation failed, missing fields: ${missingFields.join(", ")}`, {
                    logger: this.logger,
                    tryNextLink: false,
                });
            }
            ...
            throw new _smithy_core_config__WEBPACK_IMPORTED_MODULE_0__.CredentialsProviderError(`Failed to load token from ${tokenFilePath}: ${String(error)}`, {
                logger: this.logger,
                tryNextLink: false,
            });
        }
    ...
    createDPoPInterceptor(middlewareStack) {
        middlewareStack.add((next) => async (args) => {
            if (_smithy_core_protocols__WEBPACK_IMPORTED_MODULE_2__.HttpRequest.isInstance(args.request)) {
    ...
    async generateDpop(method = "POST", endpoint) {
        ...
        try {
            ...
            throw new _smithy_core_config__WEBPACK_IMPORTED_MODULE_0__.CredentialsProviderError(`Failed to generate Dpop proof: ${error instanceof Error ? error.message : String(error)}`, { logger: this.logger, tryNextLink: false });
        }
    }
}
...
/* harmony import */ var _LoginCredentialsFetcher__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(2708);
...
const fromLoginCredentials = (init) => async ({ callerClientConfig } = {}) => {
    ...
    const profileName = (0,_smithy_core_config__WEBPACK_IMPORTED_MODULE_2__.getProfileName)({
        profile: init?.profile ?? callerClientConfig?.profile,
    });
    const profile = profiles[profileName];
    if (!profile?.login_session) {
        throw new _smithy_core_config__WEBPACK_IMPORTED_MODULE_1__.CredentialsProviderError(`Profile ${profileName} does not contain login_session.`, {
            tryNextLink: true,
            logger: init?.logger,
        });
    }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   fromLoginCredentials: () => (/* reexport safe */ _fromLoginCredentials__WEBPACK_IMPORTED_MODULE_0__.fromLoginCredentials)
/* harmony export */ });
/* harmony import */ var _fromLoginCredentials__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2707);
